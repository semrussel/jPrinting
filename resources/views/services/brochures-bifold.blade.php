...
@section('serv-name') <b>Services</b> | Brochures | Bi-fold @stop
            ...
            @for($i=1; $i<=5; $i++)
                <div class="col-sm-6 col-md-4 no-pad-left">
                    <label style="display: block;">
                        <div class="serv-browse" style="background: url('img/brochures bi-fold/des-{{ $i }}.jpg'); background-position: center center;background-size: cover;">
