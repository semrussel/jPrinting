            ...
            @for($i=1; $i<=7; $i++)
                <div class="col-sm-6 col-md-4 no-pad-left">
                    <label style="display: block;">
                        <div class="serv-browse" style="background: url('img/flyers 1-side/des-{{ $i }}.jpg'); background-position: center center;background-size: cover;">
...
<!-- Price Calculator -->
    ...
    <input type="hidden" value="flyers 1-side" name="product">
