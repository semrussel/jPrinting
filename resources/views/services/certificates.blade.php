...
@section('serv-img') 
            ...
            @for($i=1; $i<=5; $i++)
                <div class="col-sm-6 col-md-4 no-pad-left">
                    <label style="display: block;">
                        <div class="serv-browse" style="background: url('img/certificates/des-{{ $i }}.jpg'); background-position: center center;background-size: cover;">
    ...
    <div id="d-upload" class="design-box" style="display: none;"> 
        <img id="upload-img" name="file" src="img/serv-16.jpg" width="100%" style="border: 1px solid grey">
        <div class="clear"></div><br>
        <input class="btn btn-primary" type="file" name="pic" accept="image/*">
    </div>
    <div class="clear"></div><hr>
    <p><b>Additional Details</b></p>
        <textarea name="description" class="form-control" rows="8" id="comment" required>Achievement:&#13;Name:&#13;Event:&#13;Description:&#13;Date:&#13;Signed By:&#13;Extras:</textarea>
    <div class="clear"></div><br>
@stop
...
<!-- Price Calculator -->
    ...
    <input type="hidden" value="certificates" name="product">
