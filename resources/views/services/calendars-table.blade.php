...
@section('serv-img') 
            ...
            @for($i=1; $i<=7; $i++)
                <div class="col-sm-6 col-md-4 no-pad-left">
                    <label style="display: block;">
                        <div class="serv-browse" style="background: url('img/calendars table/des-{{ $i }}.jpg'); background-position: center center;background-size: cover;">
    ...
    <div id="d-upload" class="design-box" style="display: none;"> 
        <img id="upload-img" name="file" src="img/serv-01.jpg" width="100%" style="border: 1px solid grey">
...
<!-- Price Calculator -->
    ...
    <input type="hidden" value="calendars table" name="product">
