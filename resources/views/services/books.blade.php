...
@section('serv-img') 
            ...
            @for($i=1; $i<=8; $i++)
                <div class="col-sm-6 col-md-4 no-pad-left">
                    <label style="display: block;">
                        <div class="serv-img" style="background: url('img/books/des-{{ $i }}.jpg'); background-position: center center;background-size: cover;">
    ...
    <div id="d-upload" class="design-box" style="display: none;"> 
        <img src="img/serv-05.jpeg" width="100%" style="border: 1px solid grey">
