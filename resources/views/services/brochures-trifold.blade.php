            ...
            @for($i=1; $i<=6; $i++)
                <div class="col-sm-6 col-md-4 no-pad-left">
                    <label style="display: block;">
                        <div class="serv-browse" style="background: url('img/brochures-trifold/des-{{ $i }}.jpg'); background-position: center center;background-size: cover;">
...
<!-- Price Calculator -->
    ...
    <p><b>Additional Details</b></p>
        <textarea class="form-control" rows="9" id="comment">Title:&#13;Sub Title:&#13;Front Text:&#13;Fold 1 Text:&#13;Fold 2 Text:&#13;Fold 3 Text:&#13;Back Text:&#13;Extras:</textarea>
