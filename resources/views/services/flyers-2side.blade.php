...
@section('serv-name') <b>Services</b> | Flyers | 2-Side  @stop
...
@section('serv-img') 
            ...
            @for($i=1; $i<=7; $i++)
                <div class="col-sm-6 col-md-4 no-pad-left">
                    <label style="display: block;">
                        <div class="serv-browse" style="background: url('img/flyers 2-side/des-{{ $i }}.jpg'); background-position: center center;background-size: cover;">
    ...
    <p><b>Additional Details</b></p>
        <textarea name="description" class="form-control" rows="5" id="comment" required>Title:&#13;Sub Title:&#13;Front Text:&#13;Extras:</textarea>
    <div class="clear"></div><br>
@stop
...
<!-- Price Calculator -->
    ...
    <input type="hidden" value="flyers 2-side" name="product">
