...
@section('serv-img') 
            ...
            @for($i=1; $i<=6; $i++)
                <div class="col-sm-6 col-md-4 no-pad-left">
                    <label style="display: block;">
                        <div class="serv-browse" style="background: url('img/brochures quad-fold/des-{{ $i }}.jpg'); background-position: center center;background-size: cover;">
    ...
    <p><b>Additional Details</b></p>
        <textarea name="description" class="form-control" rows="10" id="comment" required>Title:&#13;Sub Title:&#13;Front Text:&#13;Fold 1 Text:&#13;Fold 2 Text:&#13;Fold 3 Text:&#13;Fold 4 Text:&#13;Back Text:&#13;Extras:</textarea>
    <div class="clear"></div><br>
@stop
...
<!-- Price Calculator -->
    ...
    <input type="hidden" value="brochures quad-fold" name="product">
