            ...
            @for($i=1; $i<=4; $i++)
                <div class="col-sm-6 col-md-4 no-pad-left">
                    <label style="display: block;">
                        <div class="serv-browse" style="background: url('img/notebooks-wiresoft/des-{{ $i }}.jpg'); background-position: center center;background-size: cover;">
...
<!-- Price Calculator -->
    ...
    <input type="hidden" value="notebooks | wire bound, soft cover" name="product">
