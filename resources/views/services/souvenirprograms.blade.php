...
@section('serv-name') <b>Services</b> | Souvenir Programs  @stop
...
@section('serv-img')
            ...
            @for($i=1; $i<=6; $i++)
                <div class="col-sm-6 col-md-4 no-pad-left">
                    <label style="display: block;">
                        <div class="serv-browse" style="background: url('img/souvenir programs/des-{{ $i }}.jpg'); background-position: center center;background-size: cover;">
    ...
    <p><b>Additional Details</b></p>
        <textarea name="description" class="form-control" rows="8" id="comment" required>Title:&#13;Sub Title:&#13;Date:&#13;Extras:</textarea>
    <div class="clear"></div><br>
@stop               
...
<!-- Price Calculator -->
    ...
    <input type="hidden" value="souvenir programs" name="product">
