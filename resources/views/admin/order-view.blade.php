	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="col-xs-6">
			    ...
			    <div class="col-xs-8 no-pad"><input name="id" type="text" id="width" class="form-control" disabled></div>
			    <div class="clear"></div><br>

			    <div class="col-xs-4 right"><p><b>Product Type: </b></p></div>
			    <div class="col-xs-8 no-pad"><input name="product" type="text" id="width" class="form-control" disabled></div>
			    ...
			    <div class="col-xs-8 no-pad"><textarea name="address" class="form-control" rows="3" id="delivery-address" disabled></textarea></div>
			    <div class="clear"></div><hr>
